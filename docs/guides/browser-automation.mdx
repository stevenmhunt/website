---
description: "Selenium WebDriver, Capybara and more"
---
...
Serenity BDD is an open source reporting library for the **JVM** that helps you write better
...
To take a screenshot on failure, you can configure an [`After` hook](../cucumber/api.mdx#after).

<Tabs>
    <Tab lang="java">
With [WebDriver](https://www.selenium.dev/documentation/webdriver/browser/windows/#takescreenshot):
