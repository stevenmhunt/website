...
<Tabs>
    <Tab value="java,kotlin,scala">Cucumber is a Java library with extensions for different tools and platforms. It is launched by running JUnit 4, JUnit 5, your build tool, your IDE or the CLI.</Tab>
    <Tab value="javascript">Cucumber is a command line tool. It is launched by running `cucumber-js` from the command line, or a build script.</Tab>
    <Tab value="ruby">Cucumber is a command line tool. It is launched by running `cucumber` from the command line, or a build script.</Tab>
</Tabs>
