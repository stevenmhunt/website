        ...
        <header className="hero">
            <div className="container text--center">
                <h1 className="hero__title">
                    ...
                    <span className="text--light">lets you write
                    <br/>automated tests in plain language</span>
                </h1>
                ...
                <p className="readable-blurb">Cucumber is a tool for running automated acceptance tests, written
                    in <strong>plain
                        language</strong>.
